...
var XebraNode = function (_EventEmitter) {
  ...
  */
   ...
   */
		...
		/**
   * Execute a callback function for each child of the node.
   * @ignore
   ...
   */
		...
		/**
   * Add a Parameter node to this node's children. Also adds the node as a listener for the Parameter node,
   ...
   */
		...
		/**
   * @desc Check whether all of the parameters for the object have been added yet.
   * @readonly
   * @private
   * @type {boolean}
   */
